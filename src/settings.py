...
##################################
PROJECT_NAME: str = "Cheque Detection"
PROJECT_NAME_FULL: str = "Cheque Detection"
...
RELEASE_DATE: Optional[str] = "2020-05-24"  # e.g. "YYYY-MM-DD"
if RELEASE_DATE is None:
    RELEASE_YEAR: int = None

HOMEPAGE_URL: str = "https://www.kaggle.com/datasets/pranav10000/chequedetection"
# e.g. "https://some.com/dataset/homepage"

PREVIEW_IMAGE_ID: int = 7098129
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/cheque-detection"
...
PAPER: Optional[Union[str, List[str], Dict[str, str]]] = ["https://link.springer.com/chapter/10.1007/978-3-319-69900-4_83"]
BLOGPOST: Optional[Union[str, List[str], Dict[str, str]]] = None
REPOSITORY: Optional[Union[str, List[str], Dict[str, str]]] = {"GitHub":"https://github.com/pvbhanuteja/bank_cheque_data"}
